...
import github.businessdirt.axite.vanadium.core.imgui.ImGuiUtils.withId
...
object SceneHierarchyPanel : ImGuiPanel("Scene Hierarchy") {
    ...
    override fun drawContent() {
        ...
        scene.forEachRootEntity(::drawEntityNode)
    ...
    private fun drawEntityNode(entity: Entity) {
        ...
        withId(entity.entity.id) {
            val opened = ImGui.treeNodeEx(name, flags)
            if (ImGui.isItemClicked()) scene.selectedEntity = entity
