...
import github.businessdirt.axite.vanadium.renderer.graph.ResourceRegistry
...
class PostProcessPass(context: Context) : RenderPass(context) {
    ...
    fun record(commandBuffer: CommandBuffer, registry: ResourceRegistry, input: String, output: String): String {
        render(commandBuffer, registry[input])
        return output
    }
